...
<%@page import="com.crud.dao.BagDAO, com.crud.bean.BagVO, java.util.*"%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>

<%
List<BagVO> list = BagDAO.listAll();
                    	...
                    	<table class="mybag-up-table">
                    		...
                    		%>
                    			<tr>
                    				...
                    				<td><a href="editForm.jsp?id=<%=list.get(i).getId()%>">수정</a></td>
                    				<td><a href="deleteFromBag.jsp?id=<%=list.get(i).getId()%>">삭제</a></td>
                    			</tr>
                        	...
                        	<tr>
                        		...
                        		<td><a href="deleteFromBag.jsp?id=${u.getId()}">삭제</a></td>
                        	</tr>
                        	</c:forEach>
                        	-->
                    	</table>
